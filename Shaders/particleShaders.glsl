...
uniform mediump float radiusOfSource;    // for FXType 2 && FXType 4 && FXType 5
uniform mediump vec2 destination;       // for FXType 2 && FXType 5
...
void main(){
    if(FXType == 1.0){
        ...
        particleCenter = directedParticlesFX(center, radiusOfSource, destination, iGlobalTime, randVals, maxLifetime);
    }
