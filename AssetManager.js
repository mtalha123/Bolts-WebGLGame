define(['Custom Utility/getTextResource', 'Custom Utility/getSimplexNoiseTexture', 'Custom Utility/getWorleyNoiseTexture', 'Custom Utility/getGlTextureForImage', 'Custom Utility/getGLTextureForNoise'], function(getTextResource, getSimplexNoiseTexture, getWorleyNoiseTexture, getGLTextureForImage, getGLTextureForNoise){
    ...
    function loadAllAssets(gl, callbackForEachLoaded, callbackWhenAllLoaded){
        ...
        Promise.all([
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Assets/arial.fnt", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
               getTextResource("http://192.168.0.22:4000/Shaders/commonFunctions.glsl", function(error, text){
                   numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
               getTextResource("http://192.168.0.22:4000/Shaders/lightningShaders.glsl", function(error, text){
                   numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/targetShaders.glsl", function(error, text){
                    numLoadedAssets++;
                    shaders.target = text;
                    callbackForEachLoaded(numLoadedAssets/numTotalAssets);
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/textShaders.glsl", function(error, text){
                    numLoadedAssets++;
                    shaders.text = text;
                    callbackForEachLoaded(numLoadedAssets/numTotalAssets);
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/cursorShaders.glsl", function(error, text){
                    numLoadedAssets++;
                    shaders.cursor = text
                    callbackForEachLoaded(numLoadedAssets/numTotalAssets);
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/comboShaders.glsl", function(error, text){
                    numLoadedAssets++;
                    shaders.combo = text;
                    callbackForEachLoaded(numLoadedAssets/numTotalAssets);
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/backgroundFieldShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/lightningOrbShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/spikeEnemyShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/orbWithLightningStreakShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/bubblyOrbShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/triangularTargetShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/fourPointTargetShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/particleShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/linkShaders.glsl", function(error, text){
                    numLoadedAssets++;
                    shaders.link = text;
                    callbackForEachLoaded(numLoadedAssets/numTotalAssets);
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/fullScreenColorShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.22:4000/Shaders/lifebarShaders.glsl", function(error, text){
                    numLoadedAssets++;
