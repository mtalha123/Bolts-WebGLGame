define(['Custom Utility/getTextResource', 'Custom Utility/getSimplexNoiseTexture', 'Custom Utility/getWorleyNoiseTexture', 'Custom Utility/getGlTextureForImage', 'Custom Utility/getGLTextureForNoise'], function(getTextResource, getSimplexNoiseTexture, getWorleyNoiseTexture, getGLTextureForImage, getGLTextureForNoise){
    ...
    function loadAllAssets(gl, callbackForEachLoaded, callbackWhenAllLoaded){
        ...
        Promise.all([
            ...
            new Promise(function(resolve, reject){
               getTextResource("http://192.168.0.19:4000/Shaders/commonFunctions.glsl", function(error, text){
                   numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/backgroundFieldShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/lightningOrbShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/spikeEnemyShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/orbWithLightningStreakShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/bubblyOrbShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/triangularTargetShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/fourPointTargetShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/particleShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/linkShaders.glsl", function(error, text){
                    numLoadedAssets++;
                    shaders.link = text;
                    callbackForEachLoaded(numLoadedAssets/numTotalAssets);
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/fullScreenColorShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/lifebarShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/tentacleEnemyShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/orbitEnemyShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/ringLightningShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/teleportationTargetShaders.glsl", function(error, text){
                    numLoadedAssets++;
            ...
            new Promise(function(resolve, reject){
                getTextResource("http://192.168.0.19:4000/Shaders/lightningStrikeShaders.glsl", function(error, text){
                    numLoadedAssets++;
