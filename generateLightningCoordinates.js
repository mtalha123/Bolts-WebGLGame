define(['Custom Utility/Random', 'Third Party/Matrix'], function(Random, Matrix){
    ...
    function LightningPiece(canvasWidth, canvasHeight, pathArray, boltpieces, fluctuation, options){        
        ...
        this._offsetX = Math.floor(0.0020 * canvasWidth) + fluctuation;
        this._offsetY = Math.floor(0.027 * canvasHeight) + fluctuation;
        ...
        for(var a = 0; a < this._numberOfFrames; a++){
            ...
            for(var e = 0; e < pathArray.length; e++){
                ...
                for(var b = 0; b <= (pathArray[e].length - 4); b+=2){
                    ...
                    t_lightningCoordinates.push(movingX + (currentFirstX - this._lowestXCoordinate)); 
                    t_lightningCoordinates.push(generatedY + (currentFirstY - this._lowestYCoordinate));
                    ...
                    matrix.translate(t_lightningCoordinates[t_lightningCoordinates.length - 2], t_lightningCoordinates[t_lightningCoordinates.length - 1]);
                    ...
                    for(var i = 0; i < (boltPieces-1); i++){   
                        ...
                        t_lightningCoordinates.push(generatedPoint.x, generatedPoint.y);
                    }
                    ...
                    t_lightningCoordinates.push(generatedPoint.x);             
                    t_lightningCoordinates.push(generatedPoint.y);             
                ...
                if(options.closePath){
                    ...
                    //lightningCoordinates.push(lightningCoordinates[0], lightningCoordinates[1]);                   
                }
                
                //lightningCoordinates = lightningCoordinates.concat(t_lightningCoordinates);
                lightningCoordinates.push(t_lightningCoordinates);;
                t_lightningCoordinates = [];
            }
        }
        return lightningCoordinates;
    }
