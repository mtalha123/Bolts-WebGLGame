define(['Handlers/Handler', 'Custom Utility/getGLCoordsFromNormalizedShaderCoords', 'Custom Utility/getVerticesNormalized', 'Custom Utility/Vector', 'timingCallbacks'], function(Handler, getGLCoordsFromNormalizedShaderCoords, getVerticesNormalized, Vector, timingCallbacks){
    ...
    function StraightArrowHandler(shouldDraw, canvasWidth, canvasHeight, gl, zOrder, widthAndHeight, opts, ShaderLibrary, textureData){        
        this._uniforms = {
            iResolution: {
                type: "vec2",
        ...
        this._shaderProgram = ShaderLibrary.requestProgram(ShaderLibrary.STRAIGHT_ARROW); 
    ...
    StraightArrowHandler.prototype = Object.create(Handler.prototype);
    StraightArrowHandler.prototype.constructor = StraightArrowHandler; 

    StraightArrowHandler.prototype.doSliceEffect = function(duration, numTimesToDoEffect){
    ...
    StraightArrowHandler.prototype._generateVerticesFromCurrentState = function(){
