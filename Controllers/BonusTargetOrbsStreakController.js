define(['Entities/BonusTargetOrbStreak', 'SynchronizedTimers', 'Border', 'Custom Utility/Random', 'EventSystem', 'Controllers/EntityControllerThatSpawns', 'Custom Utility/Vector'], function(BonusTargetOrbStreak, SynchronizedTimers, Border, Random, EventSystem, EntityControllerThatSpawns, Vector){
    ...
    function BonusTargetOrbsStreakController(gl, appMetaData, maxEntitiesToSpawn, spawnChance, EffectsManager, AudioManager, TextManager){
        ...
        for(var i = 0; i < maxEntitiesToSpawn; i++){
            this._entitiesPool[i] = new BonusTargetOrbStreak(appMetaData.getCanvasWidth(), appMetaData.getCanvasHeight(), gl, this._targetRadius, new Vector(100, 100), EffectsManager, AudioManager, TextManager);
        }
    }
